    ...
    return(
        <div>
            ...
            <div style={{ border: '2px solid green', borderRadius: '10px', padding: '1rem', backgroundColor: 'rgba(107, 142, 35, 0.3)', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
                <img src={dragon} alt={dragon} style={{ width: 'auto', height: 'auto', objectFit: 'cover', gridColumn: '1 / 3',gridRow: '1 / 4' }} />
                <div className="product_text" style={{ fontStyle: 'italic', marginBottom: '0.5rem', gridColumn: '2 / 3', gridRow: '1 / 4' }}>Name: Drangon Plant</div>
                <div className="product_text" style={{ fontStyle: 'italic', marginBottom: '0.5rem', gridColumn: '2 / 3' , gridRow: '2 / 4'}}>Sold by: Maria Florista</div>
